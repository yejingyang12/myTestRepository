(function () {
  ...
  Vue.component('fishbone1',function (resolve, reject) {
    $.get(comp_src+'/compnents/private/fishbone1/fishbone1.html').then(function (res) {
      resolve({
        template:res,
        data:function () {
          return data;
        ...
        methods:{
          ...
          queryNextOperators: function(_self){
          	var url="node/queryExamineNodeList";//鱼骨图
        		var _self=this;
        		var dataparmars={
        				"systemId": systemId,//鱼骨图的系统id
        		};
         ...
         /* closes:function (msg) {
          ...
          querySuccess:function(_self,responseData){
          	...
          	if(responseData.data.operation == '申请变更'){
          		$("#dialogFishBone1").css('display','block');
          		}
