...
*/          },
					queryChangeSuccess:function(_self,responseData){
						if(responseData.data.changeContent==''&&responseData.data.changeReason==''){
							//显示弹窗
							this.showDialog();
	            $(".table-responsive").css("opacity","0.1");
	            $(".h-table-border").css("opacity","0.1");
	            $(".header-2").css("opacity","0.1");
	            $(".h-bread-le").css("opacity","0.1");
	            $("#h-height-search").css("opacity","0.1");
	            $(".container_hide").css("opacity","0.1");
...
//							window.location.href=originUrl+encodeURI("/page/applicationChangePage?systemId="+ responseData.data.systemId +"&fkCompanyCode="+companyCode+"&companyId="+companyId);
          ...
          closes:function () {
            ...
            $(".h-table-border").css("opacity","1");
            $(".header-2").css("opacity","1");
            $(".h-bread-le").css("opacity","1");
            $("#h-height-search").css("opacity","1");
            $(".container_hide").css("opacity","1");  
          ...
          importGarding: function(e){
          	...
          	if(e.target.files.length!=0){
            	...
            	if(fileFormatLength){
            		...
            		if(fileFormat[i] != 'xlsm' && fileFormat[i] !='xlsx' && fileFormat[i] !='xls'){
